 ...
 * clear the currency database table
 */
class CurrencyClearErrorMessage extends ResponseMessage
{

	const USER_MESSAGE = "An unknown error occured while clearing currencies.";
	const ERROR_LEVEL = parent::LOG_LEVEL_CRITICAL;

	/**
	 * Construct a new user-friendly error message for clearing currencies.
	 * 
